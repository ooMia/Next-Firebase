        ...
        <div className={`p-10`}>
            <form>
                <div className={`flex flex-row`}>
                    <select value={category ? category : 0} className={`font-bold text-2xl`}
                                     onChange={e => {
                        ...
                        {categoryList.map(
                            (e) =>
                                <option value={e.id} key={e.id} className={``}>{e.name}</option>)
                        }
                    </select>

                    {category && parseInt(category) > 0 && <select value={subcategory ? subcategory : 0} className={`font-bold text-2xl pl-3`}
                                            onChange={e => {
