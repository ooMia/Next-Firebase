...
const Input = (props: props) => {
  return (
    <div>
      <label className='block text-sm font-bold text-slate-400 tracking-tighter mb-2'>
        {props.name}
      </label>
      <input
        required
      ...
      />
      <p
        className='peer-valid:invisible peer-invalid:visible m-2 text-xs mb-4 tracking-tighter'
